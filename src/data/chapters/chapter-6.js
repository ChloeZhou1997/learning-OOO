...
{ type: 'mcq', question: 'In a game engine, "GameObject" would most likely be identified as a:', options: ['Method', 'Attribute', 'Class', 'Interface'], answerIndex: 2 },
...
{ type: 'coding-challenge', question: 'Design a simple Drawing Application using CRC cards. Identify at least 3 classes with their responsibilities and collaborations.', modelAnswer: 'CRC Card Design:\\n\\n1. Shape\\n   - Responsibilities: Store position, color, calculate area, draw itself\\n   - Collaborations: Canvas, Tool\\n\\n2. Canvas\\n   - Responsibilities: Manage shapes, handle drawing surface, refresh display\\n   - Collaborations: Shape, Tool, Layer\\n\\n3. Tool\\n   - Responsibilities: Handle user input, create/modify shapes, manage tool state\\n   - Collaborations: Shape, Canvas\\n\\n4. Layer\\n   - Responsibilities: Group shapes, manage visibility, handle z-ordering\\n   - Collaborations: Shape, Canvas' }
]
}
};
